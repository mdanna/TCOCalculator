const tco = {
  ...
  calculate({numApps, numUsers, numSimple, numModerate, numComplex}){
    ...
    const costMXGoYear1 = (costMXGoSvcs + costMXGoLic) / 1000;
    // Total MX Go Cost: 3 Year [F]
    const costMXGoYear3 = (costMXGoSvcs + costMXGoLic * 3) / 1000;
    // Total MX Go Cost: 5 Year [K]
    const costMXGoYear5 = (costMXGoSvcs + costMXGoLic * 5) / 1000;
    ...
    const costCompetitorYear1 = (costCompetitorSvcs + costCompetitorLic) / 1000;
    // Total Competitor Cost: 3 Year [G]
    const costCompetitorYear3 = (costCompetitorSvcs + costCompetitorLic * 3) / 1000;
    // Total Competitor Cost: 5 Year [L]
    const costCompetitorYear5 = (costCompetitorSvcs + costCompetitorLic * 5) / 1000;
